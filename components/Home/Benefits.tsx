  ...
  return (
    ...
    >
      <Box textAlign={{ lg: "center" }}>
        ...
        >
          Discover the incredible benefits of embracing a diet rich in fruits,
      ...
      >
        ...
        >
          How does your company compare? Learn how your company stacks up in the
          industry.
        </Feature>
        <Feature
          color="blue"
        ...
        >
          Goals, Breakouts, Instant notifications, Comparisons, Annotations and
          Cohort Analysis!
        </Feature>
      </SimpleGrid>
    </Box>
